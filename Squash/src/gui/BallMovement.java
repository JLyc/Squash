...
import static gui.XYPositionConstants.*;
...
public class BallMovement implements Runnable
{
	...
	public void moveOrBounce()
	{
		...
		else if (positionX <= COURT_WEST_POINT)
		{
			x = RIHT_OR_DOWN;
		}
		else if (positionX >= COURT_EAST_POINT - 15)
		{
			x = LEFT_OR_UP;
		}
		else if (positionY <= COURT_NORTH_POINT)
		{
			y = RIHT_OR_DOWN;
		}
		else if (positionY == COURT_SOUTH_POINT)
		{
